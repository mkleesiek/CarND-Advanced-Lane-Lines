...
The goal of highway lane detection is achieved by implementing the following components of an image processing pipeline:
...
<img src="output_images/test5.jpg" width="250">

In case of videos, the fit results are compared along multiple frames and averaged for calculating the lane statistics.
...
* [input_images](input_images): Input folder for example images
* [output_images](output_images): Output folder for images processed with the current [P1.ipynb](P1.ipynb)
* [input_videos](input_videos): Input folder for example videos
* [output_video](output_video): Output folder for videos processed with the current [P1.ipynb](P1.ipynb)
